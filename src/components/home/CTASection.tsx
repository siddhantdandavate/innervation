        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-section-dark-foreground">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="mailto:info@innervationit.com" className="text-white/80 hover:text-accent transition-colors text-lg">
        ...
        <div className="container-narrow py-16 lg:py-20">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="text-center lg:text-left">
              <span className="text-white/50 text-sm uppercase tracking-wider font-medium">Let's collaborate</span>
