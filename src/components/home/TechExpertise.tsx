          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
              {technologies.cloud.map((tech) => (
                <span
                  key={tech}
                  className="px-4 py-2 rounded-lg bg-card border border-border text-foreground text-sm font-medium hover:border-accent/30 hover:bg-accent/5 transition-all duration-300 cursor-default"
                >
                  {tech}
                </span>
              ))}
